...
base_url = 'http://www.saksfifthavenue.com/Shoes/Wedding/shop/_/N-52k0sz/Ne-6lvnb5?FOLDER%3C%3Efolder_id=2534374306624275&Nao='
    ...
    for image_item in img_lst:
        try:
            ...
            if image_link.startswith('http'):
                ...
                f = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/saks/images/wedding_%s.png' % str(product_id)
                         , 'w')
                b = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/saks/text/ProductNames_wedding.txt','w')
    ...
    for product_item in product_lst:
        try: 
            ...
            if product_link.startswith('http'):
                ...
                w = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/saks/text/ProductURL_wedding.txt', 'w')
