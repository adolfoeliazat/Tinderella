...
base_url = 'http://www.barneys.com/barneys-new-york/women/shoes/sandals#sz=48'
num_pages = 11
    ...
    for image_item in img_lst:
        try:
            ...
            if image_link.startswith('http'):
                ...
                f = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/barneys/images/sandals_%s.png' % str(product_id)
                         , 'w')
                b = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/barneys/text/ProductNames_sandals.txt','w')
    ...
    for product_item in product_lst:
        try: 
            ...
            if product_link.startswith('http'):
                ...
                w = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/barneys/text/ProductURL_sandals.txt', 'w')
