...
base_url = 'http://shop.nordstrom.com/c/womens-sandals-shop?origin=leftnav#category=b2372949'
num_pages = 31
...
# # Category = 'sandals'
    ...
    for image_item in img_lst:
        try:
            ...
            if image_link.startswith('http'):
                ...
                print counter, ',', title
                f = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/nordstrom/images/sandals_%s.png' % str(product_id)
                         , 'w')
                b = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/nordstrom/text/ProductNames_sandals.txt','w')
    ...
    for product_item in product_lst:
        try: 
            ...
            w = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/nordstrom/text/ProductURL_sandals.txt', 'w')
