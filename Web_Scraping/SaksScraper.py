...
class SaksScraper(object):
    ...
    def join_url(self):
        ...
        category_dict = {
            'boots':
            'Boots/shop/_/N-52k0sa/Ne-6lvnb5?FOLDER<>' +
            'folder_id=2534374306624250',
            'evening':
            'Evening/shop/_/N-52k0sg/Ne-6lvnb5?FOLDER<>' +
            'folder_id=2534374306624256',
            'exotics':
            'Exotics/shop/_/N-52k0sh/Ne-6lvnb5?FOLDER<>' +
            'folder_id=2534374306624257',
            'flats':
            'Flats/shop/_/N-52k0s8/Ne-6lvnb5?FOLDER<>' +
            'folder_id=2534374306624248',
            'mules_slides':
            'Mules-and-Slides/shop/_/N-52k29y/Ne-6lvnb5?FOLDER<>' +
            'folder_id=2534374306626182',
            'wedges':
            'Wedges/shop/_/N-52k0t0/Ne-6lvnb5?FOLDER<>' +
            'folder_id=2534374306624276',
            'pumps_slingbacks':
            'Pumps-and-Slingbacks/shop/_/N-52k0sm/Ne-6lvnb5?FOLDER<>' +
            'folder_id=2534374306624262',
            'sandals':
            'Sandals/shop/_/N-52k0st/Ne-6lvnb5?FOLDER<>' +
            'folder_id=2534374306624269',
            'sneakers':
            'Sneakers/shop/_/N-52k0sy/Ne-6lvnb5?FOLDER<>' +
            'folder_id=2534374306624274',
            'wedding':
            'Wedding/shop/_/N-52k0sz/Ne-6lvnb5?FOLDER<>' +
            'folder_id=2534374306624275',
            'oxfords_loafers_moccasins':
            'Oxfords-Loafers-and-Moccasins/shop/_/N-52k0si/Ne-6lvnb5?' +
            'FOLDER<>folder_id=2534374306624258'}
