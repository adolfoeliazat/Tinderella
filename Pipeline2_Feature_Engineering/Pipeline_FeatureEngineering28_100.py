...
class Feature_Engineer(object):
    ...
    def create_feature_vector(
        ...
        """
          ...
          #column wise concatenate flattened filtered image
          to label, pre_features and post_features arrays.
        ...
        for i, subdir in enumerate(clean_stand_img_directory_lst):
            ...
            for j, img_file in enumerate(clean_img_lst):
                ...
                try:
                    ...
                    post_trans_feat, post_feat_det_size = self.post_trans(
                    ...
                    np.savetxt(
                        '%s%s.csv' %
                        (self.cached_feature_vector_file,
                         img_file),
                        feat_vector,
                        fmt='%.18e',
                        delimiter=',')
