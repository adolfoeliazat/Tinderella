...
class Feature_Engineer(object):
    ...
    def feature_preprocessing(self):
        ...
        label_vec = []
        f = open(
            '%s/size_new_twenty_100_100_10e_test15k_labels.csv' %
            FeatVecs_path,
            'w')
        t = open(
            '%s/size_new_twenty_100_100_10e_test15k_items.csv' %
            FeatVecs_path,
            'w')
        ...
        np.save('%s/rescaled_new_feat_matrix_100_100_10e_test15k.npy'
...
if __name__ == '__main__':
    ...
    cach_FeatVecs_path = os.path.join(
        FeatVecs_path,
        'size_new_twenty_100_100_10e_test15kfeat/')
