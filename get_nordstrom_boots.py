...
base_url = 'http://shop.nordstrom.com/c/womens-boots?origin=leftnav#category=b60139933'
num_pages = 16
...
# # Category = 'boots'
    ...
    for image_item in img_lst:
        try:
            ...
            if image_link.startswith('http'):
                ...
                print counter, ',', title
                f = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/nordstrom/images/boots_%s.png' % str(product_id)
                         , 'w')
                b = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/nordstrom/text/ProductNames_boots.txt','w')
    ...
    for product_item in product_lst:
        try: 
            ...
            w = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/nordstrom/text/ProductURL_boots.txt', 'w')
