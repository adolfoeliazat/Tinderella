    ...
    for image_item in img_lst:
        try:
            ...
            if image_link.startswith('http'):
                ...
                f = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/saks/images/sandals_%s.png' % str(product_id)
                         , 'w')
                b = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/saks/text/ProductNames_sandals.txt','w')
    ...
    for product_item in product_lst:
        try: 
            ...
            if product_link.startswith('http'):
                ...
                w = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/saks/text/ProductURL_sandals.txt', 'w')
