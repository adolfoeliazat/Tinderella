...
class Feature_Engineer(object):
	...
	def feature_preprocessing(self):
		...
		full_matrix = []
		label_vec = []
		f = open('%s/size_new_twenty_200_200_10e_test15k_labels.csv'%FeatVecs_path, 'w')
		t = open('%s/size_new_twenty_200_200_10e_test15k_items.csv'%FeatVecs_path, 'w')
		# f = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/size_twenty_200_200_10e_labels.csv', 'w')
		...
		np.save('%s/rescaled_new_feat_matrix_200_200_10e_test15k.npy' %FeatVecs_path, rescaled_feat_matrix) 

		return rescaled_feat_matrix, label_vec,item_name

if __name__ == '__main__':
	dir_path = '/Users/heymanhn/Virginia/Zipfian/Capstone_Project'
	full_dir_path = os.path.join(dir_path, 'Output_Images_new_twenty_200')
	...
	cach_FeatVecs_path = os.path.join(FeatVecs_path, 'size_new_twenty_200_200_10e_test15kfeat/')
