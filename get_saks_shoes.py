...
# , base_url + '&Nao=180', base_url + '&Nao=360'
    ...
    for image_item in img_lst:
        try:
            ...
            if image_link.startswith('http'):
                ...
                #          , 'w')
                f = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/images/saks/boots_%s.png' % str(product_id)
                         , 'w')
                b = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/images/saks/product_names.txt','w')
    ...
    for product_item in product_lst:
            try: 
                ...
                if product_link.startswith('http'):
                    ...
                    w = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/images/saks/product_links.txt', 'w')
                    w.write(str(product_dict))
            except:
                pass


re.search(r"(?P<product_id>\d+)\_(\d+)",image_link)
