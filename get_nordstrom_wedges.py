...
base_url = 'http://shop.nordstrom.com/c/wedges-for-women?origin=leftnav#category=b60177734'
num_pages = 10
...
# # Category = 'wedge'
    ...
    for image_item in img_lst:
        try:
            ...
            if image_link.startswith('http'):
                ...
                print counter, ',', title
                f = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/nordstrom/images/wedges_%s.png' % str(product_id)
                         , 'w')
                b = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/nordstrom/text/ProductNames_wedges.txt','w')
    ...
    for product_item in product_lst:
        try: 
            ...
            w = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/nordstrom/text/ProductURL_wedges.txt', 'w')
