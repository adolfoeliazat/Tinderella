...
def results():
	...
	mean_img_array = np.mean(np.array(app.feature_matrix[cards_liked]), axis=0)
	...
	for n in neighbors[0]:
		...
		results_images.append('/static/shoes/' + app.images[n])
		count = 0
	...
	return render_template('results.html', images=results_images, metadata=results_meta)
