            ...
            $items.each(function() {
              ...
              if (itemData) {
                ...
                */
                ...
                if (document.referrer.indexOf('/o/') > -1) itemData.CategoryId = 'From outfit page';
                ...
                attrArray[39] = nord.config.settings.product.styleId;
                attrArray[42] = nord.config.settings.product.percentOff;
                attrArray[44] = ($('#rack-banner').length===1 ?"Y":"N");
...
function openCenteredPopup(friendlyURL, w, h) {
    var left = (screen.width / 2) - (w / 2),
    	top = (screen.height / 2) - (h / 2),
		splitterWindow = window.open('', null, 'height=' + h + ', width=' + w + ', left=' + left + ', top=' + top + ',resizable=yes, status=yes, toolbar=no, menubar=no, location=no');
		splitterWindow.location.href = PageParameters.storeUrl + friendlyURL;
		//splitterWindow.document.referrer = window.location.href;
};