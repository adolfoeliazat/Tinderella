...
base_url = 'http://www.saksfifthavenue.com/Shoes/Evening/shop/_/N-52k0sg/Ne-6lvnb5?FOLDER%3C%3Efolder_id=2534374306624256&Nao='
    ...
    for image_item in img_lst:
        try:
            ...
            if image_link.startswith('http'):
                ...
                b = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/saks/text/ProductNames_evenings.txt','w')
    ...
    for product_item in product_lst:
        try: 
            ...
            if product_link.startswith('http'):
                ...
                w = open('/Users/heymanhn/Virginia/Zipfian/Capstone_Project/saks/text/ProductURL_evenings.txt','w')
